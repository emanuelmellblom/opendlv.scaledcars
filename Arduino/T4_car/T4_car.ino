...
// For speed
unsigned long lastDist; // measures the previous movements
unsigned long lastTime; //  and stores them globally just to get the remainder which is the last distance and time for that traveled
