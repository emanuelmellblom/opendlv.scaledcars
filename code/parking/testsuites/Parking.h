 ...
 */
class ParkingTestling : public Parking {
    private:
        ParkingTestling();
    
    public:
        ParkingTestling(const int32_t &argc, char **argv) :
            Parking(argc, argv) {}

        // Here, you need to add all methods which are protected in Parking and which are needed for the test cases.
};

/**
 * The actual testsuite starts here.
 */
class ParkingTest : public CxxTest::TestSuite {
    private:
        ParkingTestling *dt;
    ...
    public:
        ...
        void setUp() {
            ...
            dt = new ParkingTestling(argc, argv);
        }
        ...
        void testParkingSuccessfullyCreated() {
            TS_ASSERT(dt != NULL);
        }
    ...
    private:
         ...
         */
        ParkingTest(const ParkingTest &/*obj*/);
         ...
         */
        ParkingTest& operator=(const ParkingTest &/*obj*/);
